...
import { View, Text, Modal, SafeAreaView, TextInput, Pressable } from 'react-native'
            ...
            >
                <View className='bg-white w-[375px] h-[667px] p-[20px] rounded-[10px] overflow-y-auto shadow-md flex items-center justify-center'>
                    <View className='w-[360px] h-[200px] space-y-3'>
                        ...
                        <Text className='color-[#003366] text-[30px]'>Create Your New List:</Text>
                        <TextInput 
                        ...
                        <Pressable className='w-[90px] h-[40px] border bg-transparent rounded-md flex items-center justify-center' onPress={closePopupWindow}>
